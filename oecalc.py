...
def nonlocOEcalc(filepath, segs):
    ...
    for word in wordlist:
            ...
            if len(word)<2:
                ...
                for pair in segpairsinword:
                    ...
                    segs[pair[0]+'1'] += 1 #count actual observed freq of seg 1 in pair
                    segs[pair[1]+'2'] += 1 #count actual observed freq of seg 2 in pair
    for pair in pairs:
    ...
    print('pair count is ' + str(paircount))
    print(segs)
    return(pairs)
